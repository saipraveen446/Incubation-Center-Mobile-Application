...
public class UsereventpostMyAdapter extends RecyclerView.Adapter<UsereventpostMyAdapter.MyViewHolder> {
    Context context;
    ArrayList<Eventitems> list;


    public UsereventpostMyAdapter(Context context, ArrayList<Eventitems> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, Uepost.class);
                i.putExtra("title",eventitems.getEvent_title());
                i.putExtra("desc",eventitems.getEvent_desc());
